...
const char* keys  =
        "{w        | 4               | Number of squares in X direction }"
        "{h        | 5               | Number of squares in Y direction }"
        "{l        | 0.04            | Marker side length (in meters) }"
        "{s        | 0.005           | Separation between two consecutive markers in the grid (in meters) }"
        "{d        | 11              | dictionary: DICT_4X4_50=0, DICT_4X4_100=1, DICT_4X4_250=2,"
        "DICT_4X4_1000=3, DICT_5X5_50=4, DICT_5X5_100=5, DICT_5X5_250=6, DICT_5X5_1000=7, "
        "DICT_6X6_50=8, DICT_6X6_100=9, DICT_6X6_250=10, DICT_6X6_1000=11, DICT_7X7_50=12,"
        "DICT_7X7_100=13, DICT_7X7_250=14, DICT_7X7_1000=15, DICT_ARUCO_ORIGINAL = 16}"
        "{@outfile |camera_calib.yaml | Output file with calibrated camera parameters }"
